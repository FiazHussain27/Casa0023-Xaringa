...
.pull-right[
```{r, echo=FALSE, out.width="100%", fig.cap="Landsat 9 false colour composite (B5-B4-B3), Cape Town, June 2022. Red = active vegetation, grey-blue = urban. Source: USGS."}
...
.pull-right[
```{r, echo=FALSE, out.width="100%", fig.cap="Landsat 8 TIRS thermal image showing land surface temperature variation. Source: NASA (public domain)"}
knitr::include_graphics("figures/Urban-heat.jpg")
```
]
...
.pull-right[
.pull-left[
```{r, echo=FALSE, out.width="100%", fig.cap="Beijing 1978 (Landsat 3). Source: NASA SVS (public domain)"}
knitr::include_graphics("figures/beijing_1978.0660_web.png")
```
]

.pull-right[
```{r, echo=FALSE, out.width="100%", fig.cap="Beijing 2010 (Landsat 5). Red = urban expansion. Source: NASA SVS (public domain)"}
knitr::include_graphics("figures/beijing_2010.1020_web.png")
```
]
]

.footnote[Wulder et al. (2022) DOI: 10.1016/j.rse.2022.113195]
