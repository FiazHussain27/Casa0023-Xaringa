...
.pull-right[
```{r, echo=FALSE, out.width="100%", fig.cap="Landsat 8 TIRS thermal image, Larsen C ice shelf calving, 2017. Orange = warmest. Source: NASA Earth Observatory (public domain)"}
...
.pull-right[
```{r, echo=FALSE, out.width="100%", fig.cap="Landsat false-colour composite showing Beijing urban expansion 1978–2011. Red = vegetation, tan = built-up. Source: NASA Earth Observatory (public domain)"}
